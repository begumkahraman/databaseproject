...
export default function Register() {
  ...
  return (
    ...
    >
      ...
      {/* KART YAPISI: Zemin #fae6e6 (Koyu Pudra) */}
      <div className="bg-[#fae6e6]/90 backdrop-blur-md rounded-3xl shadow-2xl w-96 overflow-hidden border border-[#fff0f5] p-8">
        ...
        <div className="text-center mb-6">
          ...
          <p className="text-[#D36E70]/70 text-sm mt-2">Kütüphane dünyasına adım at.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="pt-2">
            ...
            />
             <p className="text-[10px] text-center text-[#D36E70]/60 mt-1">*Sadece yöneticiler içindir, boş bırakabilirsiniz.</p>
          </div>
        ...
        <p className="mt-6 text-center text-sm text-[#D36E70]/80">
          Zaten hesabın var mı? <Link to="/login" className="font-bold text-[#D36E70] hover:underline hover:text-[#B55E75]">Giriş Yap</Link>
        </p>
      </div>
    </div>
  );
